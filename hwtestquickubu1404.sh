...
# sudo chmod 755 /media/ubuntu/YOURDRIVE/hwtestquick1404.sh
# sudo ./media/ubuntu/YOURDRIVE/hwtestquick1404.sh
# OR
# sudo /bin/bash /media/ubuntu/YOURDRIVE/hwtestquick1404.sh
